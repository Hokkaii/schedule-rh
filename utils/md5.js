...
export const signatureSecret = 'dd05f1c54d63749eda95f9fa6d49v442a';

export class signMd5Utils {
  /**
   * json参数升序
   * @param jsonObj 发送参数
   */
  ...
  static getVSign (data, sign) {
    try {
      let jsonObj = data
        ? isString (data) ? JSON.parse (JSON.stringify (data)) : {...data}
        : {};
      jsonObj['sign'] = sign;
      let signParamObj = {};
      ...
      return md5 (
        JSON.stringify (requestBody) + signatureSecret
      ).toUpperCase ();
    } catch (e) {
      return '';
    }
